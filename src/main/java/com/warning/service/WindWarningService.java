...
public class WindWarningService {
    ...
    // 默认阈值（硬编码兜底，单位 m/s）
    private static final double DEFAULT_YELLOW = 10.8;
    private static final double DEFAULT_ORANGE = 17.2;
    private static final double DEFAULT_RED = 24.5;
